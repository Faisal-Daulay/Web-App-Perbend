  ...
  <div class="col-md-12">
    <div class="box box-success box-solid">
      <div class="box-header with-border">
        <h3 class="box-title">
          <i class="fa fa-inbox"></i> Data Dokumen Penguna Jasa
        </h3>
        ...
        <section class="content">
          <div class="row">
            <div class="col-md-12">
              ...
              <a href="include/laporan/laporan_pj_proses.php?id=<?= $id_pj ?>" class="btn btn-warning">Export to Excel</a>
              <div class="box-body">
