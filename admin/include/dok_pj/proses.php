...
$tujuan1 = "img/file_pj/surat_konfirmasi/$tgl_sekarang-$konfirmasi";

$lokasi_awal_bpj = $_FILES['bpj']['tmp_name'];
$bpj = $_FILES['bpj']['name'];
$tujuan2 = "img/file_pj/surat_bpj/$tgl_sekarang-$bpj";
...
if ($edit == "edit") {
	...
	if ($peneliti == "") {
		...
		$tambah = mysqli_query($db, "UPDATE dok SET pbj = '$tgl_sekarang-$bpj', tgl_pbj = NOW() WHERE dok.id_dok = '$id'   ");
