<div class="row">
  <div class="col-lg-4 col-xs-6">
    ...
    <div class="small-box bg-green">
      ...
      <a href="img/file_info/259pmk10.pdf" class="small-box-footer">Lihat Selengkapnya <i class="fa fa-arrow-circle-right"></i></a>
    </div>
  </div><!-- ./col -->
  <div class="col-lg-4 col-xs-6">
    <!-- small box -->
    <div class="small-box bg-green">
      ...
      <a href="img/file_info/2bc2011.pdf" class="small-box-footer">Lihat Selengkapnya <i class="fa fa-arrow-circle-right"></i></a>
    </div>
  </div><!-- ./col -->
  <div class="col-lg-4 col-xs-6">
    <!-- small box -->
    <div class="small-box bg-green">
      ...
      <a href="img/file_info/janji-layanan.pdf" class="small-box-footer">Lihat Selengkapnya <i class="fa fa-arrow-circle-right"></i></a>
    </div>
  </div><!-- ./col -->
      ...
      <div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:980px;height:380px;overflow:hidden;">
        ...
        ?>
          <div style="background-color:#000000;">
            <img data-u="image" style="opacity:0.5;" src="img/img_slider/<?php echo $foto_slide; ?>" />
