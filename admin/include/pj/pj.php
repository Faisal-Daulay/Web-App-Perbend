    ...
    <div class="box box-success box-solid">
      ...
      <div class="box-body">
        <section class="content">
          <div class="row">
            <div class="col-md-12">
              <a href="?page=pj/form_pj.php">
                <button type="submit" class="btn btn-primary tambah">Tambah Data</button>
              </a>
              <a href="include/laporan/laporan_pj.php" class="btn btn-warning">Export to Excel</a>
              <div class="box-body">
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        <td><?php echo $no++; ?></td>
                        <td>
                          <img src="img/img_pj/<?php echo $foto; ?>" width='100' alt="<?php echo $nama_pj; ?>">
                        </td>
                        ...
                        <td>
                          <div class="dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dLabel">
                              ...
                              <li><a onClick="return confirm('Apakah anda yakin untuk menghapus?')" href="?page=pj/proses.php&id=<?php echo $id; ?>">Delete</a></li>
