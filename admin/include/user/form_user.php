                    ...
                    echo "
                      <form action='?page=user/proses.php' method='post'>
                        ...
                        <div class='form-group'>
                          ...
                          <input type='text' name='user' readonly class='form-control' placeholder='Username' value='$user'>
                        </div>
                        <div class='form-group'>
                          <label>Password</label>
                          <input type='password' name='pass' readonly class='form-control' placeholder='Password' value='$password'>
                        </div>
                        <div class='form-group'>
