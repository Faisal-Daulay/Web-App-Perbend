              ...
              <div class="box-body">
                <?php 
                  ...
                  if (isset($id)) {
                    ...
                    echo "
                      <form action='?page=penjamin/proses.php' method='post' enctype='multipart/form-data'>
                        <input type='hidden' name='aksi' value='$aksi'>
                        <input type='hidden' name='id' value='$id'>

                        <div class='form-group'>
                          <label>Nama Penjamin</label>
                          <input type='text' name='nama_penjamin' class='form-control' value='$nama_pj'>
                        </div>
                        <div class='form-group'>
                          <label>Email</label>
                    ...
                    echo "
                      <form action='?page=penjamin/proses.php' method='post' enctype='multipart/form-data'>
                        ...
                        <div class='form-group'>
                          <label>Nama Penjamin</label>
                          <input type='text' name='nama_penjamin' class='form-control' placeholder='Nama Pengguna Jasa'>
                        </div>
                        <div class='form-group'>
                          <label>Email</label>
