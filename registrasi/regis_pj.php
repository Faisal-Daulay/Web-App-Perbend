...
<body class="hold-transition login-page">
  <div class="login-box">
    <div class="login-logo">
      <a href="index.php"><b>Registrasi</b><br />Pengguna Jasa</a>
    </div><!-- /.login-logo -->
    <div class="login-box-body" id="wrapper">
      <p class="login-box-msg">Sign up to start your session</p>
      <form action="regis_pro_pj.php" method="post" enctype="multipart/form-data">
        <?php
        $aksi = 'tambah';
        ?>
        ...
        <div class='form-group'>
          ...
          <input type='text' required name='nama_pj' class='form-control' placeholder='Nama Pengguna Jasa'>
        </div>
        <div class='form-group'>
          <label>Email</label>
