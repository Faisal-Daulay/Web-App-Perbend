  ...
  <div class="col-md-12">
    <div class="box box-success box-solid">
      <div class="box-header with-border">
        <h3 class="box-title">
          <i class="fa fa-inbox"></i> Data Dokumen Penjamin
        </h3>
        ...
        <section class="content">
          <div class="row">
            <div class="col-md-12">
              ...
              <a href="include/laporan/laporan_penjamin_selesai.php?id=<?= $nama_penjamin ?>" class="btn btn-warning">Export to Excel</a>
              <div class="box-body">
                <h2>DATA YANG TELAH SELESAI DI PROSES</h2>
                <div class="table-responsive">
                  <table id="example1" class="table table-bordered table-hover">
                    ...
                    <tbody>
                      ...
                      $sql = "SELECT * FROM dok WHERE nama_penjamin = '$nama_penjamin' ORDER BY id_dok DESC";
