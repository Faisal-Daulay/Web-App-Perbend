...
$id_penjamin = $_SESSION['id_penjamin'];
$status = $_SESSION['status'];
$status_akun = $_SESSION['status_akun'];

$hml = mysqli_query($db, "SELECT * FROM penjamin WHERE id_penjamin = '$id_penjamin' ");
$ambil_penjamin = mysqli_fetch_assoc($hml);
$foto = $ambil_penjamin['foto'];
